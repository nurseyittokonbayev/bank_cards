...
import 'package:bank_cards/widgets/add_card.dart';
import 'package:bank_cards/widgets/bank_card.dart';
import 'package:bank_cards/widgets/profile.dart';
                      ...
                      builder: (context, double value, _) {
                        return Transform.translate(
                          ...
                          child: ListTile(
                            ...
                            trailing: Text(
                              "-${cards[page.round()]!.expenses.first.amount.toStringAsFixed(2)} сом",
